...
class SSHClient:
    def __init__(self, host: str, username: str, ssh_key_path: str, port: int = 22, timeout: int = 10):
        self.host = host
    ...
    def exec_command(self, command: str) -> tuple[str, str, str]:
        try:
            ...
            return exit_code, _stdout.read().decode("utf-8"), _stderr.read().decode("utf-8")
