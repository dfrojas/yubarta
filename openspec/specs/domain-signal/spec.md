# Capability: Domain Signal

## Purpose

Defines the canonical `Signal` type that all capabilities use to represent an internal event. Establishes the required fields, idempotency guarantees, lifecycle coverage, and raw payload preservation contract.
