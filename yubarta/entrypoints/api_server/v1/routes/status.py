...
from yubarta.entrypoints.api_server.dependencies import IncidentServiceDep, RuntimeDep
...
async def get_status(runtime: RuntimeDep, service: IncidentServiceDep) -> StatusResponse:
    incidents = await service.list_incidents(limit=50)
